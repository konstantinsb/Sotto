...
<p align="center">
  <img src="assets/screenshots/overlay.svg" alt="Оверлей-подсказка Sotto поверх живого разговора" width="660">
</p>

<p align="center">
  <img src="assets/screenshots/menubar.svg" alt="Меню Sotto в строке состояния" width="300">
  <img src="assets/screenshots/onboarding.svg" alt="Онбординг Sotto" width="300">
</p>

<p align="center">
  <img src="assets/screenshots/quick-switcher.svg" alt="Палитра быстрого переключения контекста (⌥⌘P)" width="300">
  <img src="assets/screenshots/status-hud.svg" alt="Капсула статуса при свёрнутом оверлее" width="300">
</p>

<p align="center"><sub>Экраны в дизайн-системе Sotto (тёмное стекло + индиго; цветокод источников: голос — зелёный, экран — небесный, AI — индиго). Оверлей и меню — в приложении; Quick Switcher, Onboarding и Status HUD — в разработке.</sub></p>
